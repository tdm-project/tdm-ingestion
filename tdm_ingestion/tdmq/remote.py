...
class Client(BaseClient):
    def __init__(self,
        ...
        self.entity_types_url = urljoin(self.url,
    ...
    def create_entity_types(self, sensor_types: List[EntityType]) -> List[str]:
        logger.debug('create_entity_types %s',
    ...
    def get_entity_types(
            self,
            id_: str = None,
            query: Dict = None) -> Union[EntityType, List[EntityType]]:
...
class AsyncClient(Client):
    ...
    async def create_entity_types(self,
    ...
    async def entity_types_count(self, query: Dict):
        return len(await self.http.get(self.entity_types_url,
                                       params=query)) > 0
